...
# --- Función para transcribir audio con Groq (STT) ---
def transcribir_audio_groq(api_key, audio_file_bytes):
    """
...
with col1:
    ...
    if audio_bytes:
        ...
        texto_respuesta_estudiante = transcribir_audio_groq(GROQ_API_KEY, audio_bytes.read())
